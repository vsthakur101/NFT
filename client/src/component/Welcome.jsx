        ...
        <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
          <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
              <div className={`rounded-tl-2xl ${companyCommonStyle}`}>
                Reliablity
              </div>
              <div className={`${companyCommonStyle}`}>Security</div>
              <div className={`rounded-tr-2xl ${companyCommonStyle}`}>
                Ethereum
              </div>
              <div className={`rounded-bl-2xl ${companyCommonStyle}`}>
                Web 3.0
              </div>
              <div className={`${companyCommonStyle}`}>Low Fees</div>
              <div className={`rounded-br-2xl ${companyCommonStyle}`}>
                Blockchain
              </div>
            </div>
          </div>
